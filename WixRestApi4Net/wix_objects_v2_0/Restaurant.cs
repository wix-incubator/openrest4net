...
namespace wixrest.v2_0
{
    ...
    public class Restaurant : Organization
    {
        ...
        public IList<DispatchInfo> deliveryInfos = new List<DispatchInfo>();

        public DeliveryInfo deliveriesInfo = new DeliveryInfo();
